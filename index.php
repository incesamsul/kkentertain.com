...
<head>
    <title>KK Entertain | Sewa sound makassar | Sewa lighting makassar | Profile</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
    <meta name='robots' content='max-image-preview:large' />
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="sewa lighting dan sound makassar" />
    <meta property="og:description" content="rental lighting dan sound makassar" />
...
<body>
    ...
    <nav class="navbar navbar-expand-sm navbar-light p-4 fixed-top">
        <div class="container">
            <a class="navbar-brand " href="#"><strong>KK Entertain</strong></a>
        ...
        <div class="container ">
            <div class="row  <?= $flexCenter ?>">
                <div class="col-sm-6 pe-5">
                    <h1>KK Entertain</h1>
                    <p>Event Organizer Makassaar, Sewa Sound System Makassar, Sewa Lighting Makassar</p>
            ...
            <div class="row " data-aos="fade-up" data-aos-offset="-300" data-aos-anchor-placement="center-center">
                <div class="col-sm-6 offset-sm-3 text-center">
                    ...
                    <p class="lh-base"><small>tempat yang tepat untuk mengorganisir acara impian Anda. Dengan lebih dari
                            10 tahun
                            pengalaman dalam industri ini
                        </small></p>
                    <button class="btn btn-outline-warning">Konsultasi</button>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-3">
                    ...
                    <p class="text-secondary"><small>
                            KK Entertain adalah perusahaan event organizer yang berbasis di makassar, Indonesia. Perusahaan ini berfokus pada penyelenggaraan acara-acara hiburan seperti konser musik, pertunjukan seni, festival, dan acara perusahaan. </small></p>
                </div>
                <div class="col-sm-3">
                    <ul>
